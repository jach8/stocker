''' 
    This file contains a class used to implement the "Double Expectation" (dxp) strategy.
...
class dxp:
    ...
    def __breakeven(self, option_type, strike, option_price, stock_price):
        """ Calculate the Breakeven Price for an Option Contract: 
            The Breakeven Price Percentage is calculated using the intrinisic value of the option divided by the stock price. 
                - For Calls: (Strike + Option Price - Stock Price) / Stock Price
                - For Puts: (Strike - Option Price - Stock Price) / Stock Price
        """
    ...
    def __gyf(self, ticker):
        ...
        Get the option chain via api call to yfinance. 
            - This function will return ANY Option chain weather or not it is in the database. 
            - This function does NOT update the current Optionsdb.         
        '''
        stock = ticker
        tk = yf.Ticker(stock)
